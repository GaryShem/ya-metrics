...
func FetchMetricHandler(ms shared.Repository) http.HandlerFunc {
...
func ListMetricsHandler(ms shared.Repository) http.HandlerFunc {
...
func UpdateMetricHandler(ms shared.Repository) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
